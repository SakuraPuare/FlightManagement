...
public class FlightController {
    ...
    @GetMapping("/list")
    public Response<List<Flight>> getFlightList(@RequestParam("page") int page, @RequestParam("count") int count) {

        return Response.success(flightService.getFlightsByPagination(page, count));
    }
