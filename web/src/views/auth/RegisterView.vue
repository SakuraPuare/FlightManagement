          ...
          <div class="space-y-3 md:space-y-6 w-full">
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              ...
              <router-link to="/login">
                <span class="font-medium text-pink-600 hover:underline dark:text-pink-500">Login here</span>
              </router-link>
            </p>
          </div>
          <div class="p-4">
            <div class="h-full border-r border-gray-200 dark:border-gray-700"></div>
          </div>
          <div class="w-full space-y-4">
            <div>
              <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Register as</label>
              <ul
            ...
            <template v-if="selectedIndex === 0">
              <!-- Passenger 表单 -->
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Passenger Name</label>
                <input v-model="passengerInfo.passengerName"
                  class="w-full px-4 py-2 border rounded-md dark:text-gray-900" type="text" />
              </div>
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Passenger Phone</label>
                <input v-model="passengerInfo.passengerPhone"
                  class="w-full px-4 py-2 border rounded-md dark:text-gray-900" type="tel" />
              </div>
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Identity Number</label>
                <input v-model="passengerInfo.identityNumber"
                  class="w-full px-4 py-2 border rounded-md dark:text-gray-900" type="text" />
              </div>
            </template>
            ...
            <template v-if="selectedIndex === 1">
              <!-- Merchant 表单 -->
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Merchant Name</label>
                <input v-model="merchantInfo.merchantName" class="w-full px-4 py-2 border rounded-md dark:text-gray-900"
                  type="text" />
              </div>
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Merchant Address</label>
                <input v-model="merchantInfo.merchantAddress"
                  class="w-full px-4 py-2 border rounded-md dark:text-gray-900" type="text" />
              </div>
              <div>
            ...
            <template v-if="selectedIndex === 2">
              <!-- Airline 表单 -->
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Airline Name</label>
                <input v-model="airlineInfo.airlineName" class="w-full px-4 py-2 border rounded-md dark:text-gray-900"
                  type="text" />
              </div>
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Airline Code</label>
                <input v-model="airlineInfo.airlineCode" class="w-full px-4 py-2 border rounded-md dark:text-gray-900"
                  type="text" />
              </div>
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Airline Country</label>
                <input v-model="airlineInfo.airlineCountry"
                  class="w-full px-4 py-2 border rounded-md dark:text-gray-900" type="text" />
              </div>
              <div>
            ...
            <template v-if="selectedIndex === 3">
              <!-- Staff 表单 -->
              <div>
                <label class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Staff Name</label>
                <input v-model="staffInfo.staffName" class="w-full px-4 py-2 border rounded-md dark:text-gray-900"
                  type="text" />
              </div>
            </template>
          </div>
