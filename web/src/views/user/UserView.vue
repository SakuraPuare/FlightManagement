      ...
      <div class="flex flex-row flex-wrap">
        ...
        >
          <div class="flex space-x-4">
            <div
              class="w-1/3 flex justify-items-center justify-center place-content-center"
            >
        ...
        >
          <div class="flex space-x-4">
            <div class="w-1/3 mx-auto flex justify-center">
              <div
                class="bg-gray-200 rounded-full w-24 h-24 flex justify-center items-center"
              >
                <FontAwesomeIcon
                  :icon="faPlane"
                  class="text-4xl h-[60%] text-pink-500"
                />
              </div>
            </div>
            <div class="w-2/3 space-y-4 text-nowrap">
          ...
          <div class="flex space-x-4">
            <div class="w-1/3 mx-auto flex justify-center">
              ...
              >
                <FontAwesomeIcon
                  :icon="faBuilding"
                  class="text-4xl h-[60%] text-blue-500"
                />
              </div>
            </div>
            <div class="w-2/3 space-y-4 text-nowrap">
        ...
        <div
          v-if="isPassenger(userData.role)"
          class="bg-white p-8 m-6 rounded-lg ring-0 ring-black shadow-lg max-w-screen-lg"
        >
          <div class="flex space-x-4">
            <div class="w-1/3 mx-auto flex justify-center">
          ...
          <div class="flex space-x-4">
            <div class="w-1/3 mx-auto flex justify-center">
              ...
              >
                <FontAwesomeIcon
                  :icon="faUserTie"
                  class="text-4xl h-[60%] text-purple-500"
                />
              </div>
            </div>
